...
import { addItemToCart, reduceItemQuantity, removeItemFromCart } from '../redux/slices/cart_slice';

const CartItem = ( {image,id,price,quantity,name}) => {
    ...
    <div className="flex items-start justify-between gap-4 py-8">
      <div className="flex gap-6">
        <div className="h-64 bg-gray-100 p-6 rounded">
          <img src={image} className="w-full h-full object-contain shrink-0" alt={name} />
        </div>
        <div>
          ...
          <div className="mt-6">
            <button type="button" className="flex flex-wrap gap-2 text-xl text-[#333]" >
              ...
              <span className="bg-gray-100 px-2 py-1 rounded" onClick={handleAddItem}>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" className="w-5 fill-red-500 inline cursor-pointer" viewBox="0 0 24 24" onClick={handleRemoveItem}>
